<?php
$sql_nguoidung = "SELECT * FROM tbl_dangky WHERE email='$_GET[email]' LIMIT 1";
$querynd = mysqli_query($connect, $sql_nguoidung);

?>
<h3>SỬA NGƯỜI DÙNG</h3>

<form action="modules/quanlynguoidung/xuly.php?email=<?php echo $_GET['email'] ?>" method="POST" enctype="multipart/form-data">
    <table class="tbl_themsp" width="50%" style="border-collapse: collapse;">
        <?php
