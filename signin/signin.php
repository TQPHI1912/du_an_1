    ...
    <div class="main">
        ...
        <form action="" method="POST" class="form" id="form-1">
            ...
            <div class="form-group">
                ...
                <input id="fullname" name="hovaten" type="text" placeholder="VD: Nguyen Ngoc Quan"
                    class="form-control" />
                <span class="form-message"></span>
            </div>
            <div class="form-group">
                <label for="fullname" class="form-label">Tên tài khoản</label>
                <input id="fullname" name="taikhoan" type="text" placeholder="VD: quanleaderkhmt2k14"
                    class="form-control" />
                <span class="form-message"></span>
            </div>
            ...
            <div class="form-group">
                ...
                <a style="margin-top:12px; font-size:16px;" href="/user/loginuser.php">Đăng nhập nếu có tài
                    khoản</a>
        </form>
        <div>
            <?php
