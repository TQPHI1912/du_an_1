...
<div class="container">
    ...
    <?php
    $id_dangky = $_SESSION['email'];
    $sql_get_vanchuyen = mysqli_query($connect, "SELECT * FROM tbl_dangky WHERE email='$id_dangky' LIMIT 1");
    ...
    <div class="col-md-8">
        ...
        <h4 class="contact">Nếu bạn muốn đổi địa chỉ tài khoản hãy liên hệ shop ở phần Contact nhé!</h4>
        <!--GIO HANG---->
            ...
            <tr class="tongtien">
                <td colspan="8">
                    ...
                    <p style="float: right;"><a href="pages/main/giohang/xoahetgiohang.php?xoatatca=xoahet"
                            class="delete btn btn-success">Xóa Hết</a></p>
                    ...
                    <?php
                        ...
                        ?>
                    <p class="hinhthucthanhtoan"><a href="index.php?quanly=thongtinthanhtoan"
                            class="btn btn-success">Hình thức thanh toán</a></p>
                    <?php
                        } else {
