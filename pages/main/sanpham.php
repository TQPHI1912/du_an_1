...
?>
    <div class="warpper_deital zoomer">
        <div class="hinhanh_sanpham image">
        ...
        <form class="form-sp" action="pages/main/giohang/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>" method="POST">
            <div class="chitiet_sanpham">
                ...
                <div class="price">
                    ...
                    <p class="gia-cu">
                        <?php echo number_format($row_chitiet['giasanpham'] * ($salerandom / 100) + $row_chitiet['giasanpham'], 0, ',', '.') ?>
                        VNĐ</p>
...
$sql_show_new = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.type=$bien";
