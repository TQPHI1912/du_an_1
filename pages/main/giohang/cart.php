           ...
           <?php
            ...
            ?>
                   <tr>
                       ...
                       <td style="text-align: center"><a class="xoa-sp-them" href="pages/main/giohang/xoasanpham.php?xoa=<?php echo $cart_item['id'] ?>">Xóa sản phẩm
                               trang</a></td>
                   </tr>
               <?php
                }
               ...
               <tr>
                   <td colspan="5">
                       ...
                       <?php
                        ...
                        ?>
                           <p><a href="/user/loginuser.php">Đăng nhập đặt hàng</a></p>
                       <?php
                        }
                   ...
                   <td>
                       <p style="text-align: center"><a class="xoahet" href="pages/main/giohang/xoahetgiohang.php?xoatatca=xoahet">Xóa
                               hết</a></p>
                   </td>
               </tr>
           <?php
